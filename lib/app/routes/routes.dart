    ...
    case LockScreen.routeName:
      return NoTransitionRoute<void>(
        builder: (BuildContext _) =>
            const LockScreen(authorizedAction: AuthorizedAction.launchHome),
        settings: settings,
      );
            ...
            onGenerateRoute: (RouteSettings settings) {
              ...
              switch (settings.name) {
                    ...
                    builder: (BuildContext context) =>
                        BlocProvider<PaymentLimitsCubit>(
                          create: (BuildContext context) => PaymentLimitsCubit(
                            ServiceInjector().breezSdkLiquid,
                          ),
                          child: ReceivePaymentPage(
                            initialPageIndex: settings.arguments as int?,
                          ),
                        ),
                    settings: settings,
                  );
                case ReceiveLightningAddressPage.routeName:
                  return FadeInRoute<void>(
                    builder: (BuildContext _) =>
                        const ReceiveLightningAddressPage(),
                    settings: settings,
                  );
                    ...
                    builder: (BuildContext context) =>
                        BlocProvider<PaymentLimitsCubit>(
                          ...
                          child: SendChainSwapPage(
                            btcAddressData:
                                settings.arguments as BitcoinAddressData?,
                          ),
                        ),
                    settings: settings,
                  );
                        ...
                        BlocProvider<PaymentLimitsCubit>(
                          ...
                          child: LnOfferPaymentPage(
                            lnOfferPaymentArguments:
                                settings.arguments as LnOfferPaymentArguments,
                          ),
                        ),
                    settings: settings,
                  );
                        ...
                        BlocProvider<PaymentLimitsCubit>(
                          ...
                          child: LnUrlPaymentPage(
                            lnUrlPaymentArguments:
                                settings.arguments as LnUrlPaymentArguments,
                          ),
                        ),
                    settings: settings,
                  );
                ...
                case NwcConnectionDetailPage.routeName:
                  return FadeInRoute<void>(
                    builder: (BuildContext _) => NwcConnectionDetailPage(
                      connection: settings.arguments as NwcConnectionModel,
                    ),
                    settings: settings,
                  );
                ...
                case SecuritySettings.routeName:
                  return FadeInRoute<void>(
                    builder: (BuildContext _) =>
                        const SecuredPage<SecuritySettings>(
