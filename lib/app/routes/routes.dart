            ...
            onGenerateRoute: (RouteSettings settings) {
              ...
              switch (settings.name) {
                ...
                case NwcPage.routeName:
                  return FadeInRoute<void>(builder: (BuildContext _) => const NwcPage(), settings: settings);
                case NwcConnectionDetailPage.routeName:
                  return FadeInRoute<void>(
                    builder: (BuildContext _) =>
                        NwcConnectionDetailPage(connection: settings.arguments as NwcConnectionModel),
                    settings: settings,
                  );
