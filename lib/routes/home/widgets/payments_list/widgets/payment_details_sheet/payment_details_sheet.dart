  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<AccountCubit, AccountState>(
      builder: (BuildContext context, AccountState accountState) {
        ...
        final DateTime? liquidExpiryDate = BreezDateUtils.liquidBlockDiffToDate(
          blockHeight: blockchainInfo?.liquidTip,
          expiryBlock: paymentData.details.map(
        ...
        final DateTime? bitcoinExpiryDate = BreezDateUtils.bitcoinBlockDiffToDate(
          blockHeight: blockchainInfo?.bitcoinTip,
          expiryBlock: paymentData.details.map(
        ...
        final (
          ...
          SuccessActionProcessed_Url(data: final UrlSuccessActionData data) => (
              data.description,
              '',
              data.url
            ),
                  ...
                  children: <Widget>[
                    Align(
                      child: Container(
                        ...
                        height: 6.5,
                        decoration:
                            BoxDecoration(color: Colors.white24, borderRadius: BorderRadius.circular(50)),
                      ),
                    ),
                    Padding(
                    ...
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          if (liquidExpiryDate != null &&
                              paymentData.status == PaymentState.pending) ...<Widget>[
                            PaymentDetailsSheetExpiry(expiryDate: liquidExpiryDate),
                          ],
                          if (bitcoinExpiryDate != null &&
                              paymentData.status == PaymentState.pending) ...<Widget>[
                            PaymentDetailsSheetExpiry(expiryDate: bitcoinExpiryDate),
                          ],
