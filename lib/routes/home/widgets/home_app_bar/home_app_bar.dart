...
class HomeAppBar extends AppBar {
  HomeAppBar({required ThemeData themeData, required GlobalKey<ScaffoldState> scaffoldKey, super.key})
    : super(
        centerTitle: false,
        actions: <Widget>[
          const Padding(padding: EdgeInsets.all(14.0), child: AccountRequiredActionsIndicator()),
        ],
        leading: IconButton(
