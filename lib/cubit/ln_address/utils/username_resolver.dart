...
class UsernameResolver {
  ...
  Future<String?> resolveUsername({
    ...
    try {
      ...
      final String? username = await _fromRecoveredAddress(recoveredLightningAddress) ??
          _fromProvidedUsername(baseUsername) ??
          await _fromStoredUsername() ??
          await _fromProfileName();
  ...
  Future<String?> _fromRecoveredAddress(String? recoveredLightningAddress) async {
  ...
  String? _fromProvidedUsername(String? baseUsername) {
  ...
  Future<String?> _fromProfileName() async {
    try {
  ...
  Future<String?> _fromStoredUsername() async {
    try {
